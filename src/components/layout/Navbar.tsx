...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed  w-full max-w-full z-100 
                     shadow-2xl transition-all duration-300  bg-white text-primary"
                 >
      <div className="container mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 font-bold">
          <Link to='/' className=" hover:text-backG transition-colors">Home</Link>
          <HashLink smooth to="/#features" className=" hover:text-backG transition-colors">Features</HashLink>
          <HashLink smooth to="/#how-it-works" className=" hover:text-backG transition-colors">How it works</HashLink>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          {user ? (
            <div className="flex items-center gap-2">
              <Link to={getDashboardPath()} className="p-2 text-primary hover:bg-white/10 rounded-full transition-all">
              ...
              <Button
                ...
                className="hidden md:block bg-red-500 text-white hover:bg-red-600 px-2 py-2"
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link to="/login" className="text-primary font-medium hover:opacity-80">Login</Link>
              <Link to="/signup" className="bg-primary text-white px-5 py-2 rounded-lg font-bold hover:bg-primary/90 transition-colors">
                Sign up
              </Link>
            </div>
          )}
